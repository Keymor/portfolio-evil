    ...
    return (
        <div className="w-[1954px] relative">
            <div style={{ transform: `translateY(-${scroll}svh)` }}>
                <FlameSvg svgColor="#ba0000" xPos={60} yPos={0} delay={1}/>
                {/* <img style={{
            ...
            <div >
                <FlameSvg svgColor="#ba0000" xPos={-70} yPos={50} delay={2}/>
            </div>
            <div >
                <FlameSvg svgColor="#ba0000" xPos={60} yPos={100} delay={3}/>
            </div>
            <div >
                <FlameSvg svgColor="#ba0000" xPos={-70} yPos={150} delay={4}/>
            </div>
            {/* <img style={{
