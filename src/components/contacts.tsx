...
export default function Contact() {
    return (
        <div className="h-screen w-screen flex relative">
            ...
            <div className="w-9/10 h-1/2 sm:size-fit m-auto mt-[40%] sm:mt-[10%] text-center flex flex-col gap-5 z-1">
                <h1 className="text-white font-bold text-3xl text-shadow-md">CONTACT</h1>
                <div className="sm:h-[32svh] sm:w-[34svw] h-full w-full gap-5 p-10 min-h-fit bg-black rounded-4xl flex flex-col">
