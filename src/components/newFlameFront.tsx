...
export default function NewFlameFront() {
    ...
    return (
        <div ref={ref} className='absolute w-full bottom-0'>
            ...
            <motion.div style={{ y: yYellow }} className='transform-gpu will-change-transform w-full absolute -bottom-[260svh] sm:-bottom-[210svh]'>
                <motion.img
                    whileInView={
                        { y: [0, 10, 0, -10, 0], x: [0, 20, 0] }
                    }
                ...
                <div className='w-full h-[250svh] sm:h-[200svh] bg-[#efb010] -translate-y-3 sm:-translate-y-2 transform-gpu will-change-transform' />
                <motion.div
                style={{opacity}}
